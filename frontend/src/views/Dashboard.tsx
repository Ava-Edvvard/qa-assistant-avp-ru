      ...
      >
        ...
        >
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.75rem', lineHeight: 1.4, marginTop: '-8px' }}>
            Если API-ключ не указан, бэкенд использует настройки из конфигурации сервера. Если на сервере отсутствуют ключи, приложение запустится в Mock-режиме (на умных локальных заглушках).
          </p>
